...
const Sidebar = () => {
  ...
  return (
    <div>
      ...
      {/* Sidebar Container */}
      <div
        className={`fixed lg:static top-0 left-0 w-[280px] bg-white py-4 px-6 flex flex-col justify-start items-start transition-transform duration-300 ${
      ...
      >
        ...
        <div className="w-full mt-20 flex flex-col justify-start items-start gap-2 text-red-500 flex-grow">
