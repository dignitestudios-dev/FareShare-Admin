    ...
    <div className="w-full lg:w-[70%] grid grid-cols-2 lg:grid-cols-5 justify-start items-start gap-2 lg:gap-[280px]">
      <div className="w-full lg:w-[240px] h-[100px] rounded-[24px] bg-white p-[12px] flex gap-2 items-center justify-start">
        ...
        <div className="w-auto flex flex-col justify-start items-start">
          <span className="text-[18px] font-bold text-black">{stats?.userCount || 0}+</span>
      ...
      <div className="w-full lg:w-[240px] h-[100px] rounded-[24px] bg-white p-[12px] flex gap-2 items-center justify-start">
        ...
        <div className="w-auto flex flex-col justify-start items-start">
          <span className="text-[18px] font-bold text-black">{stats?.driverCount || 0}+</span>
          <span className="text-black text-[14px] font-normal">Total Drivers</span>
        </div>
      </div>
      ...
      <div className="w-full lg:w-[240px] h-[100px] rounded-[24px] bg-white p-[12px] flex gap-2 items-center justify-start">
        ...
        <div className="w-auto flex flex-col justify-start items-start">
          <span className="text-[18px] font-bold text-black">{stats?.brokerCount || 0}+</span>
          <span className="text-black text-[14px] font-normal">Total Brokers</span>
        </div>
      </div>
      ...
      <div className="w-full lg:w-[240px] h-[100px] rounded-[24px] bg-white p-[12px] flex gap-2 items-center justify-start">
        ...
        <div className="w-auto flex flex-col justify-start items-start">
          <span className="text-[18px] font-bold text-black">{stats?.nemtCount || 0}</span>
          <span className="text-black text-[14px] font-normal">NEMT Requests</span>
        </div>
      </div>
      ...
      <div className="w-full lg:w-[240px] h-[100px] rounded-[24px] bg-white p-[12px] flex gap-2 items-center justify-start">
        ...
        <div className="w-auto flex flex-col justify-start items-start">
          <span className="text-[18px] font-bold text-black">{stats?.vehicleCount || 0}</span>
          <span className="text-black text-[14px] font-normal">Vehicle Requests</span>
        </div>
      </div>
    </div>
  );
