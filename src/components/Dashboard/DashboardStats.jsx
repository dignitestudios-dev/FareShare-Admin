    ...
    return (
      <div className="w-full grid grid-cols-2 lg:grid-cols-5 justify-start items-start gap-2 lg:gap-6">
        {[...Array(5)].map((_, index) => (
          <div
            key={index}
            className="w-full h-[88px] rounded-[24px] bg-gray-200 animate-pulse p-[12px] flex gap-2 items-center justify-start"
          >
  ...
  return (
    <div className="w-full  grid grid-cols-2 lg:grid-cols-5 justify-start items-start gap-2 lg:gap-6 ">
      <button
        ...
        className="w-full  h-[88px] rounded-[24px] bg-white p-[12px] flex gap-2 items-center justify-start"
      >
      ...
      <button className="w-full  h-[88px] rounded-[24px] bg-white p-[12px] flex gap-2 items-center justify-start">
