...
const NimtTable = ({ data, loading, setUpdate }) => {
  ...
  const filteredData = data.filter((item) => {
    const matchesSearch =
      item.insuranceCarrier.toLowerCase().includes(searchQuery.toLowerCase()) ||
      item?.insuranceNumber.includes(searchQuery?.toLowerCase()) ||
      item?.subscriberNumber.includes(searchQuery?.toLowerCase());
    const matchesTab =
