    ...
    >
      <div className="bg-white p-8 rounded-[20px] shadow-lg max-w-lg w-[552px] min-h-[289px] text-center">
        ...
        <p className="text-[#252525] text-[16px] font-normal leading-[25.34px] mb-6">
          Are you sure you want to accept this vehicle request?
        </p>
        ...
        <select
          ...
          className="h-[50px] bg-white border px-2 mb-6 outline-none  rounded-full  w-full"
        >
          <option value="">Select Vehicle Type</option>

          <option value="Standard">Standard</option>
          <option value="XL Vehicle">XL Vehicle</option>
          <option value="Lux Vehicle">Lux Vehicle</option>
          <option value="Black Lux Vehicle">Black Lux</option>
          <option value="Black Lux XL Vehicle">XL Black Lux</option>
        </select>
