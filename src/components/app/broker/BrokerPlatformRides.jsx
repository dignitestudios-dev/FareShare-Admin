...
const BrokerPlatformRides = ({ broker, loading }) => {
  ...
  const filteredData = broker?.onPlatformRides?.filter((ride) => {
          ...
          <div className="w-full  px-5 py-4 bg-gray-100 border rounded-[18px] ">
            ...
            <div className="overflow-x-auto   rounded-xl ">
              <table className="min-w-full  border-separate">
                {broker?.onPlatformRides?.length > 0 && (
                  <thead>
                ...
                <tbody className="mt-2">
                  {broker?.onPlatformRides?.length > 0 ? (
                    broker?.onPlatformRides?.map((ride, index) => (
...
export default BrokerPlatformRides;
