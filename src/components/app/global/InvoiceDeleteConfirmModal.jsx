...
const InvoiceDeleteConfirmModal = ({
  ...
  return (
    <Modal
      ...
      className="flex items-center justify-center z-[1000] outline-none backdrop-blur-sm"
      overlayClassName="fixed inset-0 bg-black bg-opacity-50 z-[1000] outline-none  flex justify-center items-center"
    >
      <div className="bg-white p-8 rounded-[20px] outline-none shadow-lg max-w-lg w-[552px] min-h-[289px] text-center">
