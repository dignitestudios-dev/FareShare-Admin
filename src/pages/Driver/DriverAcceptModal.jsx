...
const DriverAcceptModal = ({ isOpen, onRequestClose, onConfirm }) => {
  return (
    <Modal
      isOpen={isOpen}
    ...
    >
      <div className="bg-white p-8 rounded-lg shadow-lg max-w-lg w-[552px] h-[289px] text-center">
        ...
        <h2 className="text-2xl font-semibold mb-2 text-[24px]">Accept Driver Request</h2>
...
export default DriverAcceptModal;
