...
const UserDetails = () => {
  ...
  // Sample users data (can be replaced with actual data)
  const users = [
    {
      name: "Dani Mok",
          ...
          <div className="bg-white rounded-[18px] p-7 shadow-lg">
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="flex flex-col bg-[#FAFAFA] p-4 rounded-lg">
                ...
                <span className="text-[16px] font-medium text-black">Mike Smith</span>
              </div>
              
              {/* Email Address */}
              <div className="flex flex-col bg-[#FAFAFA] p-4 rounded-lg">
                <span className="text-[14px] text-[#9E9E9E]">Email Address</span>
                <span className="text-[16px] font-medium text-black">mikesmith12@gmail.com</span>
              </div>
              ...
              <div className="flex flex-col bg-[#FAFAFA] p-4 rounded-lg">
                ...
                <span className="text-[16px] font-medium text-black">-Able</span>
              </div>
              ...
              <div className="flex flex-col bg-[#FAFAFA] p-4 rounded-lg">
                ...
                <span className="text-[16px] font-medium text-black">24 Jan 1990</span>
              </div>
              
              {/* Patient Date of Death */}
              <div className="flex flex-col bg-[#FAFAFA] p-4 rounded-lg">
                <span className="text-[14px] text-[#9E9E9E]">Patient date of Death</span>
                <span className="text-[16px] font-medium text-black">24 Jan 2028</span>
              </div>
            ...
            <tbody>
              {users.map((user, index) => (
                <tr key={index} className="text-gray-900 text-[14px] border-b">
                  ...
                  <td className="py-3">{user.bookingDate}</td>
                  <td className="py-3">
                    <Link
                      // to={`/user/${user.email}`}
                      to={`/ride-details`}
