...
const BrokerComplete = () => {
  ...
  return (
    ...
    <button onClick={openModal} className="bg-[#C00000] text-white font-semibold px-8 py-4 rounded-full w-full max-w-[100%]">Invoice</button>
  </div>
          ...
          {/* Vehicle Detail */}
          <div className="bg-white rounded-[18px] p-6 shadow-lg">
          <h3 className="text-[24px] font-semibold mb-4 text-black">Driver Info</h3>

          <div className="bg-white rounded-[18px] mb-4 flex items-center gap-6">
            ...
            <div>
              ...
              <p className="text-[14px] font-semibold text-black">Mikesmith12@gmail.com</p>
              <p className="text-[14px] font-semibold text-black">+1 123 456 7980</p>

            </div>
          </div>
            <h3 className="text-[24px] font-semibold mb-4 text-black">Vehicle Details</h3>
            <img
