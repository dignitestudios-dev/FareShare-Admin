  ...
  return (
    <div className="w-full h-full bg-[#F5F7F7] p-10 overflow-auto ">
      <div className="grid grid-cols-2 gap-8">
        ...
        <div className="bg-white h-[78%] rounded-[18px] p-6 shadow-lg">
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-[22px] font-semibold text-black">Ride Detail</h3>
            <span className="bg-[#C0510033] text-[#FF6B00] px-3 py-1 rounded-full">Pending</span>
          </div>
          ...
          <div className="mt-4 flex justify-between items-center">
            ...
            <p className="text-[17px] text-red-500 font-semibold">$50</p>
          </div>
