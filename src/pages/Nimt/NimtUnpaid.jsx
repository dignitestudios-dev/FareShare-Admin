...
<div className="flex items-center">
  ...
  <button onClick={openModal} className="bg-red-500 text-white font-semibold rounded-full w-[238px] h-[48px]">
    Generate Invoice
  </button>
  <button className="bg-[#E4E4E4] text-[#868686] font-semibold rounded-full w-[238px] h-[48px]">
    Mark as Paid
  </button>
</div>
